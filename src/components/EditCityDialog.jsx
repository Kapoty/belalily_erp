...
class EditCityDialog extends React.Component {
	...
	getCity() {
		...
		fetch(Config.apiURL + "cities/" + this.props.cityId, {
			method: "GET",
			headers: { 
		...
		.then((resp) => {
			resp.json().then((data) => {
				if ('auth' in data) {
					...
					this.setState({trying: false, errorInput: 'success', errorMessage: 'Cidade atualizada!'});
				}
			})
		})
		.catch((e) => {
...
export default withStyles(useStyles)(EditCityDialog)