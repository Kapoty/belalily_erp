			...
			resp.json().then((data) => {
				if ('auth' in data) {
					...
					this.setState({
						...
						products_module: data.profile.products_module,
						product_categories_module: data.profile.product_categories_module,
						sizes_module: data.profile.sizes_module,
						...
						consultants_module: data.profile.consultants_module
					});
				}
			})
		})
