...
class AddCouponDialog extends React.Component {
		...
		.then((resp) => {
			resp.json().then((data) => {
				if ('auth' in data) {
					...
					this.setState({trying: false, errorInput: 'success', errorMessage: 'Cupom adicionado!'});
				}
			})
		})
		.catch((e) => {
...
export default withStyles(useStyles)(AddCouponDialog)