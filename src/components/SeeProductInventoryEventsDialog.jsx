...
class SeeProductInventoryEventsDialog extends React.Component {
	...
	getEvents() {
		...
		fetch(Config.apiURL + "products/inventory/" + this.props.productInventoryId + "/events", {
			method: "GET",
			headers: { 
...
export default withStyles(useStyles)(SeeProductInventoryEventsDialog)